...
// 获取用户的信息【需要带着用户的token向服务器要用户的信息】 URL:/api/user/passport/auth/getUserInfo method:get
...
// 获取订单交易页面信息: 获取商品清单 URL: /api/order/auth/trade method: get
export const reqOrderInfo = () => requests({ url: "/order/auth/trade", method: "get" })

// 提交订单的接口URL：/api/order/auth/submitOrder?tradeNo={tradeNo} method: post
...
// 获取支付订单状态URL:/api/payment/weixin/queryPayStatus/{orderId} method:get
export const reqPayStatus = orderId =>
  requests({ url: `/payment/weixin/queryPayStatus/${orderId}`, method: "get" })

// 获取个人中心 我的订单页表 URL：/api/order/auth/{page}/{limit} method：get
