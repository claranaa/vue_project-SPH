<template>
  <div class="clearfix selector">
    ...
    <!-- 下面的div class="type-wrap"是请求到服务器数据的代码 -->
    <div class="type-wrap" v-for="(attr,index) in attrsList" :key="attr.attrId">
      ...
      <div class="fl value">
        <ul class="type-list">
          ...
          <!-- 平台相应售卖属性的属性值：比如粉色，蓝色 -->
          <!-- 下面的li是请求到服务器数据的代码 div class="type-wrap"下的分类 -->
  ...
  export default {
    ...
    methods: {
      ...
      tradeMarkHandler(trademark) {
        ...
        // 为什么在父组件中发请求
        // 因为父组件中的searchParams参数是带给服务器的参数，子组件需要把点击的品牌信息传递给父组件--自定义事件
