      ...
      /* async handle(type, disNum, cart) {
        ...
        switch (type) {
          ...
          case "minus":
            ...
            break
          case "change":
            // 用户输入进来的最终量，是非法的（带有汉字|出现负数），带给服务器数字0
            if (isNaN(disNum)||disNum<1) {
              disNum = 0
            } else {
              // 属于正常情况（小数的话要取整）带给服务器的是变化的量 用户输入进来的最终的量 - 产品的起始个数
